...
### Introduction:
This web application is developed to automatically grade Task 2 writing of the IELTS exam. The application will assess essays based on certain criteria and provide automatic scoring using Gemini API.
...
- **Automatic Grading**: The application uses the Gemini API to automatically grade the essays based on IELTS standards.
